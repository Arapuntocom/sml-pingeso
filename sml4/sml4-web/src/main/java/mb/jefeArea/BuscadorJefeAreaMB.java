...
public class BuscadorJefeAreaMB {
    ...
    public String buscarFormulario() {
        ...
        FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "N.U.E. no encontrado", "Datos no válidos"));
    ...
    public String buscarFormularioRRP() {
        ...
        if (buscar != null && !buscar.equals("")) {
            ...
            switch (buscar) {
                case "Ruc":
                    mensaje = validacionVistasMensajesEJB.checkRuc(input);
                    break;
                case "Rit":
                    mensaje = validacionVistasMensajesEJB.checkRit(input);
                    break;
                case "NumeroParte":
                    int parte;
                    try {
                        ...
                        FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Debe ingresar un N° de Parte válido", " "));
                        return "";
                    }
        ...
        FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Formulario no encontrado", ""));
        logger.info("formulario no encontrado");
