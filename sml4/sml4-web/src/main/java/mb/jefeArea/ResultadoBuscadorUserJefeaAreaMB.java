...
public class ResultadoBuscadorUserJefeaAreaMB {
	...
	public String habilitarUsuario() {
    	...
    	FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Usuario Habilitado", ""));
	...
	public String deshabilitarUsuario() {
    	...
    	FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Usuario Deshabilitado", ""));
    	logger.info("fUsuario ya se encuentra deshabilitado");
